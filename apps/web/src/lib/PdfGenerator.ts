functionality to generate PDF reports from HTML templates.
...
export async function {
  ...
  if (Date.now() - start > 30000) throw new Error('Timeout'); generatePDF(htmlPath: string, pdfPath: string): Promise<void> {
  try {
