 ...
 */
export async function testColorContrast(options: ColorContrastOptions = {}): Promise<number> {
  const {
 ...
 * @returns Promise resolving when testing completes
 */
export async function testAriaRoles(options: AriaRoleOptions = {}): Promise<void> {
  const { roles = [] } = options;
 ...
 * @returns Promise resolving when testing completes
 */
export async function testFocusTrap(options: FocusTrapOptions): Promise<void> {
 ...
 * @returns Promise resolving when testing completes
 */
export async function testTouchTargets(options: TouchTargetOptions): Promise<void> {
 ...
 * @returns Promise resolving when testing completes
 */
export async function testLandmarks(landmarks: LandmarkTest[]): Promise<void> {
