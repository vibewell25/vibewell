 ...
 */
export async function hasUserSelectedLanguage(): Promise<boolean> {
  try {
 ...
 */
export async function setLanguage(locale: string, savePreference: boolean = true): Promise<boolean> {
  try {
