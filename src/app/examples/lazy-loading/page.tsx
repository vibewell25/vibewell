    ...
    <div className="container mx-auto py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 bg-blue-50 p-6 rounded-lg border border-blue-200">
          ...
          <p className="mb-4">
            This page demonstrates lazy loading of heavy components. The components below will only be loaded 
            when they're needed, reducing the initial page load time.
          </p>
  ...
  return (
    <Suspense fallback={<LoadingState />}>
      <ARViewer {...props} />
          ...
          <p>
            Benefits include smaller initial bundle size, faster initial page load, and on-demand loading 
            of heavy components only when they're needed.
          </p>
        </div>
      </div>
    </div>
