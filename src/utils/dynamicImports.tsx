...
export const EnhancedHeader = createDynamicComponent<ComponentType<any>>(async () => {
...
export const HubSearch = createDynamicComponent<ComponentType<any>>(async () => {
...
export const WebAuthnAuth = createDynamicComponent<ComponentType<any>>(async () => {
  const mod = await import('@/components/WebAuthnAuth');
  return { default: mod.WebAuthnAuth };
});

export const WebAuthnButton = createDynamicComponent<ComponentType<any>>(async () => {
