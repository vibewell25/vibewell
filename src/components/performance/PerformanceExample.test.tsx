...
describe('PerformanceExample Component', () => {
  testRunner.test('renders correctly', () => {
    ...
    expect(screen.getByText('Performance Monitoring Example')).toBeInTheDocument();
    ...
    expect(screen.getByText('No operations run yet. Click the button to start.')).toBeInTheDocument();
  });
  
  testRunner.test('runs expensive operation when button is clicked', async () => {
    // Render the component
    testRunner.render(<PerformanceExample />);
    ...
    expect(screen.queryByText('No operations run yet. Click the button to start.')).not.toBeInTheDocument();
  ...
  testRunner.testAccessibility('has no accessibility violations', <PerformanceExample />);
}); 