import { dbOptimizer, analyzeQuery } from '../../utils/db-optimization';
...
describe('Database Optimization Tests', () => {
  describe('Query Analysis', () => {
    ...
    it('should suggest indexes for common operations', () => {
      ...
      expect(suggestions).toContain('Consider adding an index for the where clause to improve performance.');
      expect(suggestions).toContain('Consider adding an index for the order by clause to improve performance.');
    });
  });
