/**
 * Analytics utilities and functions for reports and dashboards.
 */
...
function generateMockAnalyticsData(startDate: Date, endDate: Date): any {
  ...
  const previousPeriod = {
    ...
    conversionRate: (Math.floor(totalConversions * prevFactor) / Math.floor(totalSessions * prevFactor)) * 100,
