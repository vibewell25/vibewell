...
import { BarChart as BarChartIcon, LineChart as LineChartIcon, Users, DollarSign, Calendar, Activity, CreditCard } from 'lucide-react'
      ...
      {analyticsCards.map((card) => (
        <Card key={card.title}>
          ...
          <CardContent>
            ...
            <p className={`text-xs ${card.change === "increase" ? "text-green-500" : card.change === "decrease" ? "text-red-500" : "text-muted-foreground"}`}>
              {card.description}
            </p>
          </CardContent>
        </Card>
