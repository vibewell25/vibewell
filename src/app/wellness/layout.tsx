        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex justify-between items-center">
            <div className="text-gray-600 text-sm">
              © 2024 Vibewell. All rights reserved.
            </div>
            <div className="flex space-x-6">
              <Link {...createTypedLink(routes.legal.privacy)} className="text-gray-600 hover:text-gray-900 text-sm">
                Privacy Policy
              </Link>
              <Link {...createTypedLink(routes.legal.terms)} className="text-gray-600 hover:text-gray-900 text-sm">
                Terms of Service
              </Link>
              <Link {...createTypedLink(routes.legal.contact)} className="text-gray-600 hover:text-gray-900 text-sm">
                Contact Us
              </Link>
            </div>
          </div>
