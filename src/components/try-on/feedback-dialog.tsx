...
export function FeedbackDialog({ isOpen, onClose, sessionId, userId, productName }: FeedbackDialogProps) {
      ...
      <DialogContent>
        ...
        {submitted ? (
          ...
          <div className="py-4 space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium mb-2">Would you try this product in real life?</label>
            ...
            {/* Comments */}
            <div>
              <label className="block text-sm font-medium mb-2" htmlFor="comment">Additional comments (optional)</label>
              <Textarea
                id="comment"
