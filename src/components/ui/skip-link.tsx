  ...
  return (
    <a
      ...
      className={cn(
        ...
        'absolute left-0 top-0 z-50 rounded bg-white px-4 py-3 text-sm font-medium text-primary transition',
        // Visually hidden by default
        '-translate-y-full opacity-0',
        // Visible when focused - slides into view from the top
        'focus:translate-y-0 focus:opacity-100 focus:outline-2 focus:outline-offset-2 focus:outline-primary',
