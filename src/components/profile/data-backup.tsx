  ...
  const handleBackup = async () => {
    try {
      ...
      for (let i = 0; i < backupData.length; i++) {
        ...
        setBackupData((prev) =>
          prev.map((item, index) =>
            index === i ? { ...item, status: "downloaded" } : item
          )
        );
      }
      ...
      <CardContent className="space-y-6">
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Before deleting your account, we recommend downloading a backup of your
            data. This will allow you to keep a copy of your information.
          </p>
          ...
          <div className="flex justify-end">
            <Button
              ...
              disabled={isBackingUp || allDownloaded}
            >
